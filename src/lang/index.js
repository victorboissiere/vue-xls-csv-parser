export default {
  ...
  ru: {
    ...
    submit: 'Отправить',
    close: 'OK',
    columnData: 'Данные в столбце',
    chooseColumn: 'Выберите столбец',
    selected: 'Выбрано',
    select: 'Выбор',
    selectColumn: 'Пожалуйста выберите столбец',
    file: {
      select: 'Пожалуйста, выберите файл',
      tryAgain: 'Выберите другой файл',
      withHeaders: 'Этот файл содержит заголовки',
      withoutHeaders: 'Этот файл не содержит заголовки',
    },
    error: {
      title: 'Ошибка',
      columnNumber: 'Не достаточное количество столбцов. <br><b>Обязательные столбцы</b>: ',
      missingColumns: 'Отсутствуют обязательные столбцы:',
      selectColumn: 'Вы должны выбрать все столбцы',
      fileNumber: 'Вам нужно выбрать файл',
      fileSelection: 'Файл не выбран',
      invalidFile: 'Этот файл является недействительным. Попробуйте использовать файл CSV или Xlsx',
      noWorksheet: 'Файл должен иметь хотя бы один рабочий лист',
      emptyWorksheet: 'Рабочий лист пуст',
    },
  },
};
