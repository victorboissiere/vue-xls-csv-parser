export default {
  en: {
    ...
    error: {
      title: "Error",
      columnNumber:
        "You do not have enough columns. <br><b>Required columns are</b>: ",
  ...
  es: {
    ...
    submit: "Enviar",
    close: "OK",
    columnData: "Información para",
    chooseColumn: "Selecciona una columba",
    selected: "Seleccionada",
    select: "Seleccionar",
    selectColumn: "Favor de elegir una columna",
    file: {
      select: "Favor de selecionar un archivo",
      tryAgain: "Selecciona otro archivo",
      withHeaders: "Este documento contiene encabezados",
      withoutHeaders: "Este documento no contiene encabezados",
    },
    error: {
      title: "Error",
      columnNumber:
        "El documento no contiene suficientes columnas.<br><b>Las columnas obligatorias son</b>:",
      missingColumns: "Faltan columnas obligatorias:",
      selectColumn: "Debes seleccionar todas las columnas",
      fileNumber: "Necesitas seleccionar un archivo",
      fileSelection: "No se ha seleccionado ningún archivo",
      invalidFile:
        "Este archivo no es válido. Intente utilizar un archivo CSV o Xlsx",
      noWorksheet: "Debe tener al menos una hoja de trabajo",
  ...
  fr: {
    ...
    error: {
      title: "Erreur",
      columnNumber:
        "Vous n'avez pas assez de colonnes. <br><b>Vous devez avoir les colonnes suivantes</b>: ",
      ...
      invalidFile:
        "Ce fichier est invalide. Veuillez essayer avec un fichier CSV ou Xlsx",
  ...
  nl: {
    ...
    error: {
      title: "Fout",
      columnNumber:
        "Je hebt niet genoeg kolommen. <br><b>Benodigde kolommen zijn</b>: ",
