export default {
  ...
  de: {
    ...
    chooseColumn: 'Wählen Sie eine Spalte',
    selected: 'Ausgewählt',
    select: 'Auswählen',
    selectColumn: 'Bitte wählen Sie eine Spalte',
    file: {
      select: 'Bitte wählen Sie eine Datei',
      tryAgain: 'Wählen Sie eine andere Datei',
      withHeaders: 'Diese Datei beinhaltet Überschriften',
      withoutHeaders: 'Diese Datei beinhaltet keine Überschriften',
    },
    error: {
      title: 'Fehler',
      columnNumber: 'Sie haben nicht genügend Spalten. <br><b>Benötigte Spalten</b>: ',
      missingColumns: 'Benötigte Spalten nicht vorhanden:',
      selectColumn: 'Sie müssen alle Spalten auswählen',
      fileNumber: 'Sie müssen eine Datei auswählen',
      fileSelection: 'Keine Datei ausgewählt',
      invalidFile: 'Diese Datei ist ungültig. Bitte versuchen Sie CSV oder Xlsx Dateien',
      noWorksheet: 'Mindestens ein Arbeitsblatt muss vorhanden sein',
      emptyWorksheet: 'Das Arbeitsblatt ist leer',
    },
  },
};
